...
var krpanoplugin = function() {
    ...
    function j() {
        ...
        if(typeof window.radar.mouseup === "function" && !down){
            window.radar.mouseup(plugin.currheading);
        }
    }
    function m(b) {
        if (null == f) j(b);
    ...
    function C() {
        ...
        h = !0;
        console.log("1",a)
        h && (h = !1, g.setstyle(t, p, u, v, w), g.drawpie(c / 2 - 0.5, c / 2 - 0.5, b, a - 0.5 * e, a + 0.5 * e), currheading = a - r,console.log(a))


        if(typeof window.radar.mousemove === "function"){
            window.radar.mousemove(plugin.currheading);
            //console.log("a", a, "currheading", currheading, "x", a - 0.5 * e);
        }

        if(typeof window.radar.mousedown === "function" && down){
            window.radar.mousedown(plugin.currheading);
        }
    }

    window.radar?window.radar:(window.radar = {});
    var plugin = null;
    var down = false;
    var editmode=null;
    var currheading=0;
    ...
    this.registerplugin = function(b, a, j) {
        ...
        d = f = null;
            ...
            a.drawpie = function(a, b, d, c, e) {
                ...
                //console.log(a, b, f, c, d, d, h, g, e);
                //console.log("d", "M " + a + "," + b + " L " + f + "," + c + " A " + d + "," + d + " 0 " + h + " 1 " + g + "," + e + " Z");
            };
            g = a;
            plugin.child = g;
